    ...
    <div class="container-fluid">
        <button class="btn text-light fs-4" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample"
        ...
        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
            ...
            <div class="text-center">
                ...
                <div class="mt-1">
                    <?php
                    $sqlget = "SELECT nama,jabatan FROM tb_pegawai Where id=1";
